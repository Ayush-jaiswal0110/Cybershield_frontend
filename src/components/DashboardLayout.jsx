...
export default function DashboardLayout({ children, title, onChartSelect }) {
      ...
      <aside className="relative z-10 w-64 bg-white/90 dark:bg-dark-surface/90 backdrop-blur-xl border-r border-gray-200 dark:border-dark-border shadow-xl p-6 space-y-6">
        ...
        <nav className="space-y-2">
          <button
            ...
            className="flex items-center w-full text-left px-4 py-3 rounded-xl hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 text-gray-700 dark:text-white hover:text-indigo-700 dark:hover:text-indigo-300 transition-all duration-300 font-medium focus:bg-gradient-to-r focus:from-indigo-100 focus:to-purple-100 focus:text-indigo-800 active:bg-gradient-to-r active:from-indigo-100 active:to-purple-100 active:text-indigo-800"
          >
          ...
          <button
            onClick={() => navigate('/email-security')}
            className="flex items-center w-full text-left px-4 py-3 rounded-xl hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 text-gray-700 dark:text-white hover:text-indigo-700 dark:hover:text-indigo-300 transition-all duration-300 font-medium focus:bg-gradient-to-r focus:from-indigo-100 focus:to-purple-100 focus:text-indigo-800 active:bg-gradient-to-r active:from-indigo-100 active:to-purple-100 active:text-indigo-800"
          >
            <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="pt-4 border-t border-gray-200">
            <button
              ...
              className="flex items-center w-full text-left px-4 py-3 rounded-xl hover:bg-gradient-to-r hover:from-red-50 hover:to-pink-50 text-gray-700 dark:text-white hover:text-red-600 dark:hover:text-red-300 transition-all duration-300 font-medium focus:bg-gradient-to-r focus:from-red-100 focus:to-pink-100 focus:text-red-800 active:bg-gradient-to-r active:from-red-100 active:to-pink-100 active:text-red-800"
            >
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <header className="bg-white/80 dark:bg-dark-surface/80 backdrop-blur-xl border-b border-gray-200 dark:border-dark-border shadow-sm p-6 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-600 dark:text-dark-textSecondary font-medium">Admin</span>
            </div>
          </div>
        </header>
